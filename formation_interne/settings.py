"""
Django settings for formation_interne project.
...
SECRET_KEY = 'django-insecure-^4b30ajl%q^r^b88jz@q+vqnwv3n^-m2eq0s4fvm7=dp$c4rm='
...
ROOT_URLCONF = 'formation_interne.urls'
...
WSGI_APPLICATION = 'formation_interne.wsgi.application'


# Database
# https://docs.djangoproject.com/en/5.1/ref/settings/#databases

# Add this to setting to connect database 
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',  # Use 'mysql' or 'pymysql' if you installed PyMySQL
        'NAME': 'test',           # The name of your database
